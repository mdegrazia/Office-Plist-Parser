...
# Version History:
# v1.2 2013-8-4
# v1.3 2016-4-21 Added sharepoint key support
#	
...
def get_path(this_file_aliases,MRUType):
	...
	#we know that 000200 exists right before the path starts, but sometimes there are false positives before the path starts. Since 000200 will not occur in the file path
	#reverse look through the path for the first occurrence of the string.
	...
	if MRUType == "2010":
		...
		try:
			...
			print "Error on this key. Manually check " + this_file_alias 
			return("Error", "Error")
